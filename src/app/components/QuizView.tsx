    ...
    return (
      <div className="max-w-3xl mx-auto">
        <div className="bg-white rounded-2xl shadow-xl p-6 md:p-10">
          ...
          <div className="bg-gradient-to-r from-emerald-600 to-teal-600 rounded-xl p-6 md:p-8 text-white text-center mb-6">
            <h3 className="text-2xl md:text-3xl font-bold mb-3">
              Oferta Especial para Você!
            </h3>
            <p className="text-emerald-50 mb-4 text-lg">
              Comece agora e transforme suas finanças em 30 dias
            </p>
            <div className="bg-white/20 backdrop-blur-sm rounded-lg p-4 mb-4">
              <p className="text-3xl font-bold mb-1">R$ 0,00</p>
              <p className="text-emerald-100">Primeiros 30 dias grátis</p>
            </div>
            <button className="w-full bg-white text-emerald-600 font-bold py-4 px-8 rounded-xl hover:bg-emerald-50 transition-all transform hover:scale-105 shadow-lg text-lg">
